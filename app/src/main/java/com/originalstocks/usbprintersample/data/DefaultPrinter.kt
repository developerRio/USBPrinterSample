...
import com.originalstocks.usbprintersample.converter.DefaultPrintingImagesHelper
...
open class DefaultPrinter : Printer() {
    override fun useConverter(): StringToByteArrayConverter = DefaultStringToByteArrayConverter()
